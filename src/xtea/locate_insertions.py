...
def get_clipped_reads(options,repeat,annot_path_dict):
...
# OPTIONS STILL MISSING
    ...
    sf_out = f"{options.output_dir}/{repeat}/{options.sample_name}/candidate_list_from_clip.txt"
