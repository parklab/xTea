...
def gnrt_lib_config(l_rep_type, sf_folder_rep, sf_ref, sf_gene, sf_folder_xtea, sf_config_prefix):
    ...
    for s_rep_type in l_rep_type:
        if s_rep_type=="L1":# for L1
            ...
            write_to_config(sf_anno, sf_ref, sf_gene_anno, sf_copy_with_flank, sf_flank, sf_cns, sf_xtea, s_bl, s_bam1,
                            s_bc_bam, s_tmp, s_tmp_clip, s_tmp_cns, sf_config_L1)
            ...
            write_to_config(sf_anno, sf_ref, sf_gene_anno, sf_copy_with_flank, sf_flank, sf_cns, sf_xtea, s_bl, s_bam1,
                            s_bc_bam, s_tmp, s_tmp_clip, s_tmp_cns, sf_config_Alu)
            ...
            write_to_config(sf_anno, sf_ref, sf_gene_anno, sf_copy_with_flank, sf_flank, sf_cns, sf_xtea, s_bl, s_bam1,
                            s_bc_bam, s_tmp, s_tmp_clip, s_tmp_cns, sf_config_SVA)
            ...
            write_to_config(sf_anno, sf_ref, sf_gene_anno, sf_copy_with_flank, sf_flank, sf_cns, sf_xtea, s_bl, s_bam1,
                            s_bc_bam, s_tmp, s_tmp_clip, s_tmp_cns, sf_config_HERV)
            ...
            write_to_config(sf_anno, sf_ref, sf_gene_anno, sf_copy_with_flank, sf_flank, sf_cns, sf_xtea, s_bl, s_bam1,
                            s_bc_bam, s_tmp, s_tmp_clip, s_tmp_cns, sf_config_MSTA)
            ...
            write_to_config(sf_anno, sf_ref, sf_gene_anno, sf_copy_with_flank, sf_flank, sf_cns, sf_xtea, s_bl, s_bam1,
                            s_bc_bam, s_tmp, s_tmp_clip, s_tmp_cns, sf_config_Mitochondrion)
