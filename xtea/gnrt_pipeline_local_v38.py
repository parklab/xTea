...
def gnrt_running_shell(sf_ids, sf_bams, sf_10X_bams, l_rep_type, b_mosaic, b_user_par, b_force, b_tumor, f_purity,
                       ...
                       spartition, stime, smemory, ncores, sf_submit_sh, sf_case_control_bam_list="null", b_wes=False,
...
####
            s_calling_cmd = gnrt_calling_command(iclip_c, iclip_rp, idisc_c, iflt_clip, iflt_disc, ncores, iflk_len,
                                                 itei_len, iflag, b_wes, b_mosaic, b_user_par, b_force, b_tumor, b_hard_cut, b_resume, f_purity, i_rep_type, sf_pub_clip)
            if rep_type is REP_TYPE_SVA:
                s_calling_cmd = gnrt_calling_command(iclip_c, iclip_rp, idisc_c, iflt_clip, iflt_disc, ncores, iflk_len,
                                                     itei_len, iflag, b_wes, b_mosaic, b_user_par, b_force, b_tumor, b_hard_cut, b_resume, f_purity, i_rep_type,sf_pub_clip, True)
    ...
    ####
        ...
        if b_case_control==False:#this is for germline
            ...
            gnrt_running_shell(sf_id, sf_bams, sf_bams_10X, l_rep_type, b_mosaic, b_user_par, b_force, b_tumor,
                               f_purity, b_hard_cut, s_wfolder, sf_folder_rep, sf_ref, sf_gene, sf_black_list, sf_folder_xtea,
                               spartition, stime, smemory, ncores, sf_sbatch_sh, sf_bams, b_wes, b_lsf, b_slurm, b_resume, b_denovo)
