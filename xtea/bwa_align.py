...
####
    ...
    def index_fa_file(self, sf_fa):
        cmd = "%s faidx %s" % (global_values.SAMTOOLS_PATH, sf_fa)
        self.cmd_runner.run_cmd_small_output(cmd)
...
####
    ...
    def two_stage_realign(self, sf_ref_cns, sf_ref2, sf_reads, sf_out):
        ...
        m_sq_ids=self._gnrt_SQ_from_fa(sf_ref2, sf_sq)
