...
def gnrt_lib_config(l_rep_type, sf_folder_rep, sf_ref, sf_gene, sf_black_list, sf_folder_xtea, sf_config_prefix):
    ...
    for s_rep_type in l_rep_type:
        if s_rep_type==REP_TYPE_L1:# for L1
            ...
            sf_anno = "ANNOTATION " + sf_folder_rep + "Pseudogene/hg38/gencode_v28_GRCh37_exon_annotation.out\n"
            sf_anno1 = "ANNOTATION1 " + sf_folder_rep + "Pseudogene/hg38/gencode_v28_GRCh37_exon_annotation.out\n"
            sf_copy_with_flank = "L1_COPY_WITH_FLANK " + sf_folder_rep + "Pseudogene/hg38/gencode_v28_GRCh37_transcript_masked.fa\n"
            sf_flank = "SF_FLANK null\n"
