...
class BWAlign():
    ...
    def realign_clipped_reads(self, sf_ref, sf_reads, sf_out_sam):
        cmd = "{0} mem -t {1} -T {2} -k {3} -o {4} {5} {6}".format(self.BWA_PATH, self.n_jobs, self.BWA_REALIGN_CUTOFF,
                                                                  self.BWA_REALIGN_CUTOFF, sf_out_sam, sf_ref, sf_reads)
    ...
    def realign_clipped_polyA(self, sf_ref, sf_reads, sf_out_sam):
        cmd = "{0} mem -t {1} -T {2} -k {3} -o {4} {5} {6}".format(self.BWA_PATH, self.n_jobs,
