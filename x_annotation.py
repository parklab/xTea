...
class XAnnotation():
        ...
        with open(sf_out_fa, "w") as fout_fa:
            for chrm in self.m_rmsk_annotation:
                ...
                for start_pos in self.m_rmsk_annotation[chrm]:
                    ...
                    s_TE_fa_head = ">{0}{1}{2}{3}{4}{5}{6}".format(chrm, S_DELIM, start_pos, S_DELIM, end_pos, S_DELIM,
                                                                   sub_family)  ###here still keep the original pos
        ...
        with open(sf_out_fa, "w") as fout_fa:
            with open(self.sf_annotation) as fin_bed:
                for line in fin_bed:
                    ...
                    s_reg = f_ref.fetch(chrm, pstart, pend)
                    s_TE_fa_head = ">{0}{1}{2}{3}{4}".format(chrm, S_DELIM, pstart, S_DELIM, pend)
                    fout_fa.write(s_TE_fa_head + "\n")
                    fout_fa.write(s_reg + "\n")
        f_ref.close()
        ...
        with open(sf_out_fa, "w") as fout_fa:
            for chrm in self.m_rmsk_annotation:
                ...
                for start_pos in self.m_rmsk_annotation[chrm]:
                    ...
                    s_TE_fa_lhead = ">{0}{1}{2}{3}{4}{5}{6}{7}{8}L".format(chrm, S_DELIM, start_pos, S_DELIM, end_pos,
                    ...
                    ###here still keep the original pos
                    s_TE_fa_rhead = ">{0}{1}{2}{3}{4}{5}{6}{7}{8}R".format(chrm, S_DELIM, start_pos, S_DELIM, end_pos,
                                                                     S_DELIM, sub_family, S_DELIM, bi_rc)
    ...
    def bwa_index_TE_seqs(self, sf_fa):
        cmd = "{0} index {1}".format(BWA_PATH, sf_fa)
